...
export const offers = [
  ...
  {
    title: "Oferta especial en Smartphones",
    description: "15% de descuento en todos los smartphones de la categoría.",
    type: "Categoría",
    typeValue: "Porcentaje",
    value: 15.0,
  ...
  {
    title: "Descuento en MacBook Air M1",
    description: "Descuento fijo de $100 en el MacBook Air M1 durante julio.",
    type: "Producto",
    typeValue: "Fijo",
    value: 100.0,
    startDate: "2025-07-01T00:00:00.000Z",
  ...
  {
    title: "10% en servicios de reparación",
    description:
      "Descuento del 10% en todos los servicios técnicos de reparación.",
    type: "Servicio",
    typeValue: "Porcentaje",
    value: 10.0,
